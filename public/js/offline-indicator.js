...
class OfflineIndicator {
  ...
  createBanner() {
    ...
    this.banner.className =
      "fixed top-0 left-0 right-0 z-50 bg-yellow-600 text-white px-4 py-3 text-center text-sm font-medium transform transition-transform duration-300 -translate-y-full";
