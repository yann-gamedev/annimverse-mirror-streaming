...
const replacements = [
    {
        ...
        replace: '<link rel="stylesheet" href="/css/tailwind.min.css">\n    <link rel="stylesheet" href="/css/skeleton.css">'
    },
    {
        name: 'Lucide defer',
        find: /<script src="https:\/\/unpkg\.com\/lucide@latest"><\/script>/g,
        replace: '<script src="https://unpkg.com/lucide@latest" defer></script>\n    \n    <!-- Service Worker Registration -->\n    <script src="/js/sw-register.js" defer></script>\n    \n    <!-- Offline Indicator -->\n    <script src="/js/offline-indicator.js" defer></script>'
    },
    {
        name: 'Font optimization',
        find: /(<link href="https:\/\/fonts\.googleapis\.com\/css2\?family=Outfit:wght=300;400;600;700&display=swap" rel="stylesheet">)/g,
        replace: '<link href="https://fonts.googleapis.com/css2?family=Outfit:wght@300;400;600&display=swap" rel="stylesheet" media="print" onload="this.media=\'all\'">'
    }
];
